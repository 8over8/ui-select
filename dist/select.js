...
uis.controller('uiSelectCtrl',
  ...
  function ($scope, $element, $timeout, $filter, RepeatParser, uiSelectMinErr, uiSelectConfig, $parse, $injector) {
      ...
      ctrl.activate = function (initSearchValue, avoidReset) {
          // TFS 103611 - We need to clear the item list on activation. This prevents a scenario where the result list appears
      ...
      ctrl.clearResults = function () {
          // Stop any ongoing refresh events
      ...
      // Closes the dropdown
      ctrl.close = function (skipFocusser, skipNext) {
          if (!ctrl.open) return;
          ...
          switch (key) {
              case KEY.DOWN:
                  if (!ctrl.open && ctrl.multiple) {
                      ...
                      ctrl.activeIndex++;
                      if (ctrl.items[ctrl.activeIndex]._uiSelectChoiceDisabled) {
                          ctrl.activeIndex++;
                      }
                  }
                  break;
              case KEY.UP:
                  ...
                  break;
              case KEY.TAB:
                  if (!ctrl.multiple || ctrl.open) ctrl.select(ctrl.items[ctrl.activeIndex], false);
                  break;
              case KEY.ENTER:
        ...
        link: function (scope, element, attrs, ctrls) {
            ...
            $select.searchInput.on('keydown', function (e) {
                ...
                scope.$apply(function () {
                    ...
                    if (!processed && KEY.isVerticalMovement(key)) {
                        processed = _handleMatchSelection(key);
                    }
